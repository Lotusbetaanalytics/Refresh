            ...
            <div className={click ? styles.navMenuactive : styles.navMenu}>
                ...
                <ul>
                 ...
                 Stirred Yoghurt
                    ...
                    <li>
                        <a href='https://refresh.ng/' className='nav-links' onClick={closeMobileMenu} target="_blank" rel="noopener noreferrer" >
                            Shop
                        </a>
                    </li>
                    <li>
                        ...
                        <div className={styles.dropdown}>
                            <ul>
                                <li>
                                    <Link to='/distributors' className='nav-links' onClick={closeMobileMenu}>
